      ...
      <div className="inline-flex items-center focus-visible:outline-none">
        <DropdownMenu.Root open={open}>
          ...
          <DropdownMenu.Trigger asChild>
            <button
              className="rounded-full w-7 h-7 inline-flex items-center justify-center text-zdaBlue-600 dark:text-zdaBlue-500 bg-zdaBG-lightCard dark:bg-zdaBG-darkCard shadow-[0_1px_8px] shadow-slate-400 hover:shadow-slate-400/25 dark:shadow-zdaBlue-500/60 dark:hover:shadow-zdaBlue-500/25 outline outline-1 outline-zdaBlue-500/25 dark:outline-zdaBlue-500/15 hover:bg-zdaBlue-500/25 dark:hover:bg-zdaBlue-400/25 active:bg-zdaBlue-400/50 dark:active:bg-zdaBlue-500/50 transition ease-out duration-300 webkit-appearance-none appearance-none"
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content
              className="z-40 min-w-40 bg-zdaBG-lighterCard dark:bg-zdaBlue-1000 rounded-lg p-2 shadow-[0px_2px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] dark:shadow-[1px_1px_38px_-4px_rgba(34,_132,_255,_0.45),_0px_3px_20px_-15px_rgba(34,_132,_255,_0.3)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade"
              sideOffset={5}
              align="start"
              onInteractOutside={() => setOpen(false)}
            >
              <DropdownMenu.Item
                className="group flex items-center relative h-6 my-2 md:my-0 px-6 py-4 4xl:text-lg text-zdaBlue-600/90 dark:text-zdaBlue-450 rounded-md 3xl:rounded-lg select-none outline-none data-[highlighted]:bg-zdaBlue-600/75 data-[highlighted]:text-zdaBlue-50 dark:data-[highlighted]:bg-zdaBlue-450/75 dark:data-[highlighted]:text-zinc-950 motion-safe:transition-colors ease-out motion-safe:duration-200"
