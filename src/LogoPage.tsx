  ...
  return (
    <div className="flex justify-center w-full h-full">
      <div className="flex items-center flex-col md:flex-row">
        <div className="flex flex-col items-center text-md sm:text-lg 3xl:text-2xl font-light font-outfit text-zdaText-dark dark:text-zdaText-light pointer-events-none select-none">
        ...
        <div className="flex items-center text-sm sm:text-base 3xl:text-xl font-light font-outfit text-zdaText-dark dark:text-zdaText-light select-none">
          By{" "}
          <img
            ...
            height={36}
            onClick={() =>
              window.open("https://www.zerodayanubis.com/about", "_blank")
            }
          />
        </div>
      </div>
