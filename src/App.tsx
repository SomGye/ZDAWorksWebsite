...
const App = ({ route }: Props) => {
  ...
  return (
    <>
      {/* OLD NEXTJS LAYOUT */}
      <main className="flex min-h-screen flex-col items-center justify-between p-0 xs:p-12 sm:p-24">
        <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
          ...
          <div className="fixed bottom-0 left-0 flex h-auto w-full items-end justify-center bg-gradient-to-b from-zinc-200 backdrop-blur-2xl dark:md:border-t dark:border-neutral-900 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:h-auto lg:w-auto lg:bg-transparent dark:lg:bg-transparent dark:lg:border-t-0">
            <a
        ...
        <div className="mb-0 grid text-center rounded-lg lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-center lg:rounded-lg dark:border-neutral-950">
          <a
          ...
          >
            <h2
              className={`mb-3 text-2xl font-semibold inline-flex items-center`}
            >
              Ko-fi{" "}
        ...
        <div className="flex flex-col items-center relative overflow-hidden bg-zinc-950 w-full rounded-lg md:block">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
              <div className="sm:max-w-lg text-left">
                ...
                <p className="mt-4 text-xl text-gray-300">
                  The Hub of Abstract Media Creation
                </p>
                <p className="mt-4 text-xl text-gray-400 max-w-[24ch] align-center">
                  Explore the world of abstract arts, logos, wallpapers, and
                  more
                </p>
                <p className="mt-4 text-xl text-gray-600">By ZERODAYANUBIS</p>
              </div>
              <div>
                <div className="mt-10">
                  {/* Image Grid */}
                      ...
                      <div className="flex items-center space-x-6 lg:space-x-8">
                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                          <div className="h-64 w-44 overflow-hidden rounded-lg sm:opacity-0 lg:opacity-100">
                            <img
                              src="/A_Visual_Violation-800px.jpg"
                              alt=""
                          ...
                          <div className="h-64 w-44 overflow-hidden rounded-lg">
                            <img
                              src="/The_Chroma_Passage-800px.jpg"
                              alt=""
                              className="h-full w-full object-cover object-center"
                            />
                          </div>
                        ...
                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                          <div className="h-64 w-44 overflow-hidden rounded-lg">
                            <img
                              src="/Mark_of_Manifestation-800px.jpg"
                              alt=""
                              className="h-full w-full object-cover object-center"
                            />
                          </div>
                          <div className="h-64 w-44 overflow-hidden rounded-lg">
                            <img
                              src="/A_Reflection_of_Self-800px.jpg"
                              alt=""
                              className="h-full w-full object-cover object-center"
                            />
                          </div>
                          <div className="h-64 w-44 overflow-hidden rounded-lg">
                            <img
                              src="/A_System_of_Structure-800px.jpg"
                              alt=""
                              className="h-full w-full object-cover object-center"
                            />
                          </div>
                        ...
                        <div className="grid flex-shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                          <div className="h-64 w-44 overflow-hidden rounded-lg">
                            <img
                              src="/The_Crux_of_Crisis-800px.jpg"
                              alt=""
                              className="h-full w-full object-cover object-center"
                            />
                          </div>
